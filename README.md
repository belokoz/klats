...
- ⌥⌘ срабатывает, когда вы отпускаете обе клавиши, не нажав ничего другого. Поэтому если зажать ⌥⌘, ничего не нажать и отпустить, выделенный текст сконвертируется. Отменяется обычным ⌘Z.
